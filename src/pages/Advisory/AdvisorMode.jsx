...
const AdvisorMode = () => {
  ...
  if (db.loading || !brain) return <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}><RefreshCw className="animate-spin" color={COLORS.primary} /></div>;

  if (db.error) return <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px', textAlign: 'center' }}>
  ...
  return (
    <div className="no-scrollbar" style={{ paddingBottom: '2rem', fontFamily: "'Outfit', sans-serif", overflowX: 'hidden' }}>
